    ...
    <section className="py-10 md:py-12 bg-white">
      <div className="max-w-screen-xl mx-auto px-6 md:px-8">
        <div className="relative bg-teal-500 rounded-2xl overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 px-4 md:px-8 py-6">
            {/* Left - Illustration */}
            <motion.div
              animate={{ y: [0, -6, 0] }}
            ...
            <h2 className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-4xl text-black text-center font-bold">
