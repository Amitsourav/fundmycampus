...
export const metadata: Metadata = {
  title: "Study Abroad Education Loan — Collateral-Free, Starting 6.85%",
  ...
  openGraph: {
    title: "Study Abroad Education Loan — Collateral-Free, Starting 6.85% | FundMyCampus",
...
export default function Layout({ children }: { children: React.ReactNode }) {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Study Abroad Loan", item: "https://www.fundmycampus.com/abroad-study-loan" },
    ],
  };
  return (
    <>
